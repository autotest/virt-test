from autotest.client.virt import utils_misc, utils_test, storage
from autotest.client.virt import kvm_storage
    ...
    for index, image in enumerate(snapshot_chain_backward):
        ...
        if image_params.get("check_base_image"):
            ...
            if image_params.get("image_check"):
                image = kvm_storage.QemuImg(image_params, test.bindir, image)
