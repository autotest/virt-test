...
from autotest.client.tests.kvm.tests import block_mirror_stress

class BlockMirrorPowerdown(block_mirror_stress.BlockMirrorStress):
...
def run_block_mirror_powerdown(test, params, env):
    """
    block_mirror_powerdown test:
