...
from autotest.client.tests.kvm.tests import block_mirror

class BlockMirrorReboot(block_mirror.BlockMirror):
...
def run_block_mirror_reboot(test, params, env):
    """
    block_mirror_reboot test:
