...
def set_node_memtune_parameter(params):
    ...
    """
    options = params.get("options", None)
    shm_pages_to_scan = params.get("shm_pages_to_scan", None)
    shm_sleep_millisecs = params.get("shm_sleep_millisecs", None)
    shm_merge_across_nodes = params.get("shm_merge_across_nodes", None)
