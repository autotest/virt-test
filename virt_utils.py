...
class PciAssignable(object):
    ...
    def __init__(self, type="vf", driver=None, driver_option=None,
                 ...
                 host_set_flag=None, kvm_params=None, net_restart_cmd=None):
        """
        ...
        @param net_restart_cmd: command line for restart network in host
       """
        self.type = type
        self.driver = driver
        ...
        if self.kvm_params is not None:
            for i in self.kvm_params:
                if "allow_unsafe_assigned_interrupts" in i:
                    self.auai_path = i
        self.net_restart_cmd = net_restart_cmd
    ...
    def sr_iov_setup(self):
        ...
        if re_probe:
            ...
            if self.net_restart_cmd:
                utils.system(self.net_restart_cmd, ignore_status=True)
            if s:
                return False
            return True
