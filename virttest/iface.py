...
def bridged_ifaces():
    """   
    @return: returns al the interfaces which are bridged
...
def mac_of_iface(opt):
    ...
    """
    ifconf=utils.run("ifconfig %s"%opt)
...
def is_ipaddr(opt):
    ...
    if is_ipaddr_scr(opt) is 'yes' or is_ipaddr_ifcon(opt) is 'yes':
        return 'yes'
    else:
        return 'no'
def ifup(opt):
...
def chk_state_vir_iface(opt):
    ...
    """
    if is_up(opt) is 'yes':
        if state_vir_iface(opt) is 'inactive':
           return 'False'
        else:
           return 'active'
    else:
        if state_vir_iface(opt) is 'active':
           return 'False'
        else:
           return 'inactive'
...
def chk_state_vir_iface_inactive(opt):
    ...
    if is_up(opt) is 'yes':
        if state_vir_iface_inactive(opt) is 'inactive':
           return 'False'
        else:
           return 'active'
    else:
        if state_vir_iface_inactive(opt) is 'active':
           return 'False'
        else:
           return 'inactive'
...
def chk_state_vir_iface_active(opt):
    ...
    if is_up(opt) is 'yes':
        if state_vir_iface_active(opt) is 'inactive':
           return 'False'
        else:
           return 'active'
    else:
        if state_vir_iface_active(opt) is 'active':
           return 'False'
        else:
           return 'inactive'
