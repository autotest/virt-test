...
class CartesianConfigTest(unittest.TestCase):
    ...
    def testSimpleVariant(self):
        self._checkStringConfig("""
            ...
            """,
            [
            {'_name_map_file': {'<string>': ['<string>', 'a']},
             'c': 'abc',
             'dep': [],
             'name': 'a',
             'shortname': 'a',
             'x': 'va'},
            {'_name_map_file': {'<string>': ['<string>', 'b']},
             'c': 'abc',
             'dep': [],
             'name': 'b',
             'shortname': 'b',
    ...
    def testDel(self):
        self._checkStringDump("""
            ...
            """,
            [
                {'_name_map_file': {'<string>': ['<string>', '(tests=wait).long']},
                 'dep': [],
                 ...
                 'tests': 'wait',
                 'time': 'short_time'},
                {'_name_map_file': {'<string>': ['<string>', '(tests=wait).short']},
                 'dep': ['(tests=wait).long'],
                 ...
                 'tests': 'wait',
                 'time': 'logn_time'},
                {'_name_map_file': {'<string>': ['<string>', '(tests=test2)']},
                 'dep': [],
                 'name': '(tests=test2)',
                 'run': 'test1',
                 'shortname': '(tests=test2)',
    ...
    def testVariableAssignment(self):
        self._checkStringDump("""
            ...
            """,
            [
                {'_name_map_file': {'<string>': ['<string>', '(tests=system1)']},
                 'ddd': 'system154',
                 'dep': [],
                 'error': '${tests + str(system + 3)}4',
                 'name': '(tests=system1)',
    ...
    def testCondition(self):
        ...
        self._checkStringDump("""
            ...
            """,
            [
                {'_name_map_file': {'<string>': ['<string>', 'c.a']},
                 'bala': 'balabala',
                 'dep': [],
                 'foo': 'bar',
                 'name': 'c.a',
                 'shortname': 'c.a'},
                {'_name_map_file': {'<string>': ['<string>', 'c.b']},
                 'bala': 'lalalala',
                 'dep': [],
                 'foo': 'foob',
                 'name': 'c.b',
                 'shortname': 'c.b'},
                {'_name_map_file': {'<string>': ['<string>', 'd.a']},
                 'dep': [],
                 'foo': 'foo',
                 'name': 'd.a',
                 'shortname': 'd.a'},
                {'_name_map_file': {'<string>': ['<string>', 'd.b']},
                 'dep': [],
                 'foo': 'foob',
                 'name': 'd.b',
                 'shortname': 'd.b'},
