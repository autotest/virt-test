...
class PCIXML(CAPXML):
    ...
    Example:
      <capability type='pci'>
        ...
        <capability type='virt_functions'>
          ...
          <address domain='0x0000' bus='0x08' slot='0x11' function='0x0'/>
          <address domain='0x0000' bus='0x08' slot='0x11' function='0x4'/>
          <address domain='0x0000' bus='0x08' slot='0x12' function='0x0'/>
          <address domain='0x0000' bus='0x08' slot='0x12' function='0x4'/>
          <address domain='0x0000' bus='0x08' slot='0x13' function='0x0'/>
        </capability>
      </capability>
    """
    ...
    def marshal_from_address(item, index, libvirtxml):
        """Convert a Address instance into tag + attributes"""
        del index           # not used
    ...
    def marshal_to_address(tag, attr_dict, index, libvirtxml):
        """Convert a tag + attributes into a Address instance"""
        del index           # not used
        if not tag == 'address':
