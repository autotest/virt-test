...
class ServiceManagerFactory(object):
    ...
    * SpecificServiceManager:
    ...
    @staticmethod
    def create_generic_service_manager(run=utils.run):
        """
        ...
        service_manager = ServiceManagerFactory.create_service_manager()
        ...
        """
        helper = ServiceManagerFactory.FactoryHelper(run)
    ...
    @staticmethod
    def create_specific_service_manager(service_name, run=utils.run):
        """

        # Get the specific service manager for sshd
        sshd = ServiceManagerFactory.create_specific_service_manager("sshd")
        sshd.start()
        sshd.stop()
        sshd.reload()
        sshd.restart()
