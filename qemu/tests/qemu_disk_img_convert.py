...
class ConvertTest(qemu_disk_img.QemuImgTest):
      ...
      def __init__(self, test, params, env):
          self.tag = params.get("image_convert", "image1")
      ...
      def convert(self, t_params={}):
          ...
          params["image_name"] = params.get("convert_name")
          params["image_format"] = params.get("convert_format")
